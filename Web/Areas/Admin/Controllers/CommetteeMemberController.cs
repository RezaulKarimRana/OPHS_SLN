...
{
    [Area("Admin")]
    public class CommetteeMemberController : Controller
    {
        private ApplicationDbContext _context;
        public CommetteeMemberController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Save(Member model)
        {
            ...
            try
            {
                ...
                var member = new Member
                {
                    ...
                    DesignationId = (int)DesignationType.Committe_Member,
        ...
        public async Task<IActionResult> Update(Member model)
        {
            try
            {
                ...
                data.DesignationId = (int)DesignationType.Committe_Member;
