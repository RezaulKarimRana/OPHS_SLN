...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class OfficialsController : Controller
    {
        ...
        public OfficialsController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var data = await _context.Member.Where(x => x.DesignationId == (int)DesignationType.Officials).ToListAsync();
            if (data != null)
            {
        ...
        public async Task<IActionResult> Save(Member model)
        {
            ...
            try
            {
                ...
                var member = new Member
                {
                    ...
                    DesignationId = (int)DesignationType.Officials,
        ...
        public async Task<IActionResult> Update(Member model)
        {
            try
            {
                ...
                data.DesignationId = (int)DesignationType.Officials;
