...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class TeacherController : Controller
    {
        ...
        {
            var data = await _context.Member.Where(x => x.DesignationId == (int)DesignationType.Teacher).ToListAsync();
            if (data.Any())
            {
        ...
        public async Task<IActionResult> Save(Member model)
        {
            ...
            try
            {
                ...
                var member = new Member
                {
                    ...
                    DesignationId = (int)DesignationType.Teacher,
        ...
        public async Task<IActionResult> Update(Member model)
        {
            try
            {
                ...
                data.DesignationId = (int)DesignationType.Teacher;
