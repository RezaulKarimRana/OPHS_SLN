...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class HeadMasterController : Controller
    {
        ...
        {
            var data = await _context.Member.Where(x => x.DesignationId == (int)DesignationType.HeadMaster).ToListAsync();
            if (data.Any())
            {
        ...
        public async Task<IActionResult> Save(Member model)
        {
            ...
            try
            {
                ...
                var member = new Member
                {
                    ...
                    DesignationId = (int)DesignationType.HeadMaster,
        ...
        public async Task<IActionResult> Update(Member model)
        {
            try
            {
                ...
                data.DesignationId = (int)DesignationType.HeadMaster;
