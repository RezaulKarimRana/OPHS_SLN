...
{
    [Area("Admin")]
    public class AssistantTeacherController : Controller
    {
        private ApplicationDbContext _context;
        public AssistantTeacherController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var data = await _context.Member.Where(x => x.DesignationId == (int)DesignationType.Assistant_Teacher).ToListAsync();
            if (data != null)
            {
        ...
        public async Task<IActionResult> Save(Member model)
        {
            ...
            try
            {
                ...
                var member = new Member
                {
                    ...
                    DesignationId = (int)DesignationType.Assistant_Teacher,
        ...
        public async Task<IActionResult> Update(Member model)
        {
            try
            {
                ...
                data.DesignationId = (int)DesignationType.Assistant_Teacher;
