...
{
    [Area("Admin")]
    public class AssistantChairmanController : Controller
    {
        private ApplicationDbContext _context;
        public AssistantChairmanController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var data = await _context.Member.Where(x => x.DesignationId == (int)DesignationType.Assistant_Chairman).ToListAsync();
            if (data != null)
            {
        ...
        public async Task<IActionResult> Save(Member model)
        {
            ...
            try
            {
                ...
                var member = new Member
                {
                    ...
                    DesignationId = (int)DesignationType.Assistant_Chairman,
        ...
        public async Task<IActionResult> Update(Member model)
        {
            try
            {
                ...
                data.DesignationId = (int)DesignationType.Assistant_Chairman;
