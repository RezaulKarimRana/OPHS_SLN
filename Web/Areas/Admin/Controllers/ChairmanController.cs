...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class ChairmanController : Controller
    {
        ...
        {
            var data = await _context.Member.Where(x => x.DesignationId == (int)DesignationType.Chairman).ToListAsync();
            if (data != null)
            {
        ...
        public async Task<IActionResult> Save(Member model)
        {
            ...
            try
            {
                ...
                var member = new Member
                {
                    ...
                    DesignationId = (int)DesignationType.Chairman,
        ...
        public async Task<IActionResult> Update(Member model)
        {
            try
            {
                ...
                data.DesignationId = (int)DesignationType.Chairman;
